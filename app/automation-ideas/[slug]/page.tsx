...
import { ArrowLeft, Clock, DollarSign, TrendingUp, Wrench, ExternalLink, Menu, X, Calendar } from 'lucide-react';
...
export default function AutomationIdeaPage({ params }: { params: Promise<{ slug: string }> }) {
  const resolvedParams = use(params);
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  const idea = automationIdeasData[resolvedParams.slug];
