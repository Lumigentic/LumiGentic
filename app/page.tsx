...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <nav className="fixed top-0 w-full bg-black/95 backdrop-blur-sm z-50 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm">
            ...
            <a href="#market-signals" className="hover:text-gray-300 transition-colors">Market Signals</a>
      ...
      {/* Market Signals */}
      <section id="market-signals" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 border-t border-white/10 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">Market Signals</h2>
            <p className="text-lg sm:text-xl text-gray-400 italic mb-6">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white text-black rounded-lg p-6 sm:p-8 md:p-10 shadow-lg">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8">
                <div className="bg-[#1a1a1a] text-[#f2f2f2] px-4 sm:px-6 py-2 sm:py-3 rounded-md text-sm sm:text-base font-medium flex-1 sm:flex-initial min-w-0 sm:min-w-[120px] text-center">
                  Automation
                </div>
                <div className="bg-[#1a1a1a] text-[#f2f2f2] px-4 sm:px-6 py-2 sm:py-3 rounded-md text-sm sm:text-base font-medium flex-1 sm:flex-initial min-w-0 sm:min-w-[120px] text-center">
                  Augmentation
