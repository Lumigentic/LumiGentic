  ...
  return (
    <div className="h-[500px] sm:h-[600px] md:h-[40rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md px-4">
      ...
      <div className="w-full max-w-[90vw] sm:max-w-[40rem] h-40 sm:h-48 md:h-56 relative">
        ...
        <div className="absolute inset-x-16 sm:inset-x-60 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-[5px] w-1/4 blur-sm" />
        <div className="absolute inset-x-16 sm:inset-x-60 top-0 bg-gradient-to-r from-transparent via-sky-500 to-transparent h-px w-1/4" />
